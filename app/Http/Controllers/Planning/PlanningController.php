        ...
        foreach( $location_ids as $location_id ) {
            try {
                ...
                if( $exits == '' )
                {
                    ...
                    $reg3 = new TaskFiscal();
                    $reg3->requestdetailtask_id = $rdt_id;
                    $reg3->person_id = $fiscal_id;
                    $reg3->save();
                    ...
                    $isCorrect = TaskOperator::where('requestdetailtask_id', intval($rdt_id))
                                ->delete();
                    $correct =  TaskFiscal::where('requestdetailtask_id', $rdt_id)
                                ->update(['person_id'=>$fiscal_id],);
