            ...
            <tr>
                <td class="align-middle text-center font-weight-bold">
                    ...
                    if( $tlunes == 0 && $tMartes == 0 && $tMiercoles == 0 && $tJueves == 0 && $tViernes == 0 && $tSabado == 0 && $tDomingo == 0 )
                        echo '<button data-id-request-details='.$id_planlabor.' id="btn-delete-labor" class="btn btn-danger btn-sm px-2 py-0"><i class="fas fa-trash-alt"></i></button>';
                    else 
                        echo $nro++;
                    ?>
                </td>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row px-2">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <textarea id="observacion" class="form-control" rows="2" placeholder="Breve descripción"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
