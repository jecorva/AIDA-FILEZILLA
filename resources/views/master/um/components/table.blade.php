    ...
    <table id="datatable" class="table table-hover table-bordered">
        ...
        <tbody class="text-uppercase fs-13 sourcesansrg fw-500">
            ...
            <tr>
                ...
                <td class="align-middle text-center">{{ $unidad->siglas }}</td>
                <td class="align-middle">{{ $unidad->nombre }}</td>
                <td class="align-middle text-center">
                    <button onclick="editUnidadClick('{{ $id }}')" type="submit" class="<?php echo $btnWarning ?> border rounded fs-15 sourcesans tooltip-jac">
...
<script>
    ...
    function editUnidadClick(arg) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: "{!! url('api/unitm-get') !!}",
            data: data,
        }).done(function(view) {

            $("#tab-unitm-edit").html(view);
